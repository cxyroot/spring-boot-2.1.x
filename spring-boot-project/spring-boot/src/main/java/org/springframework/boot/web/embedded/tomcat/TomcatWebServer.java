...
public class TomcatWebServer implements WebServer {
	...
	public TomcatWebServer(Tomcat tomcat, boolean autoStart) {
		System.out.println("org.springframework.boot.web.embedded.tomcat.TomcatWebServer.TomcatWebServer(org.apache.catalina.startup.Tomcat)");
	...
	private void initialize() throws WebServerException {
		System.out.println("org.springframework.boot.web.embedded.tomcat.TomcatWebServer.initialize");
	...
	public void start() throws WebServerException {
		System.out.println("org.springframework.boot.web.embedded.tomcat.TomcatWebServer.start");
		synchronized (this.monitor) {
			if (this.started) {
				return;
			}
